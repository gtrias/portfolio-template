...
function portfolio_setup() {
	...
	add_editor_style( array( 'css/editor-style.css', portfolio_font_url() ) );
	...
	add_image_size( 'portfolio-full-width', 1038, 576, true );

	// This theme uses wp_nav_menu() in two locations.
	register_nav_menus( array(
		'primary'   => __( 'Top primary menu', 'portfolio' ),
		'secondary' => __( 'Secondary menu in left sidebar', 'portfolio' ),
	) );
	...
	add_theme_support( 'featured-content', array(
		'featured_content_filter' => 'portfolio_get_featured_posts',
		'max_posts' => 6,
	) );
...
add_action( 'template_redirect', 'portfolio_content_width' );
...
function portfolio_get_featured_posts() {
	 ...
	 */
	return apply_filters( 'portfolio_get_featured_posts', array() );
}
 ...
 */
function portfolio_has_featured_posts() {
	return ! is_paged() && (bool) portfolio_get_featured_posts();
}
...
function portfolio_widgets_init() {
	...
	register_sidebar( array(
		...
		'id'            => 'sidebar-1',
		'description'   => __( 'Main sidebar that appears on the left.', 'portfolio' ),
	...
	register_sidebar( array(
		'name'          => __( 'Content Sidebar', 'portfolio' ),
		'id'            => 'sidebar-2',
		'description'   => __( 'Additional sidebar that appears on the right.', 'portfolio' ),
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
		'before_title'  => '<h1 class="widget-title">',
		'after_title'   => '</h1>',
	...
	register_sidebar( array(
		...
		'id'            => 'sidebar-3',
		'description'   => __( 'Appears in the footer section of the site.', 'portfolio' ),
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
		'before_title'  => '<h1 class="widget-title">',
		'after_title'   => '</h1>',
 ...
 * @return string
 */
function portfolio_font_url() {
	$font_url = '';
	/*
	 * Translators: If there are characters in your language that are not supported
	 * by Lato, translate this to 'off'. Do not translate into your own language.
	 */
	if ( 'off' !== _x( 'on', 'Lato font: on or off', 'portfolio' ) ) {
...
function portfolio_scripts() {
	...
	if ( is_front_page() && 'slider' == get_theme_mod( 'featured_content_layout' ) ) {
		...
		wp_localize_script( 'portfolio-slider', 'featuredSliderDefaults', array(
			'prevText' => __( 'Previous', 'portfolio' ),
			'nextText' => __( 'Next', 'portfolio' )
		) );
	}
 ...
 * @return void
 */
function portfolio_admin_fonts() {
	wp_enqueue_style( 'portfolio-lato', portfolio_font_url(), array(), null );
}
add_action( 'admin_print_scripts-appearance_page_custom-header', 'portfolio_admin_fonts' );
...
function portfolio_the_attached_image() {
	 ...
	 * }
	 */
	$attachment_size     = apply_filters( 'portfolio_attachment_size', array( 810, 810 ) );
...
if ( ! function_exists( 'portfolio_list_authors' ) ) :
/**
 ...
 * @return void
 */
function portfolio_list_authors() {
		...
		<div class="contributor-info">
			...
			<div class="contributor-summary">
				...
				<a class="contributor-posts-link" href="<?php echo esc_url( get_author_posts_url( $contributor_id ) ); ?>">
					<?php printf( _n( '%d Article', '%d Articles', $post_count, 'portfolio' ), $post_count ); ?>
				</a>
 ...
 */
function portfolio_post_classes( $classes ) {
...
add_filter( 'post_class', 'portfolio_post_classes' );
